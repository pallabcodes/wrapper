...
const shared_validation_service_1 = require("../dist/validation/shared-validation.service");
const nest_zod_1 = require("@ecommerce-enterprise/nest-zod");
...
async function runSharedZodIntegrationDemo() {
    ...
    const enterpriseService = new nest_zod_1.EnterpriseZodValidationService();
    app.set('EnterpriseZodValidationService', enterpriseService);
    // Initialize shared validation service
    const sharedValidationService = new shared_validation_service_1.SharedValidationService(enterpriseService);
    // Demo data
    const demoUser = {
...
//# sourceMappingURL=shared-zod-integration.js.map